...
try:
    ...
    if scenario_number == "":
        scenario_number = str(random.randint(1,100))
except:
    print "error in scenario number - quitting...."
    quit()

try:
    haptic_feedback = raw_input("Avec ou sans retour haptique (a/avec/s/sans): \n")
    if haptic_feedback == "":
        haptic_feedback = "a"
except:
...
def UI_Sujet1():
    ...
    subprocess.call(["./UI_v7Training.py", scenario_number, "1" , str(start_time)])
    print "UI Sujet 1 Stopping ....\n"



def UI_Sujet2():
    print "UI Sujet 2 Starting ....\n"
    subprocess.call(["./UI_v7Training.py", scenario_number, "2" , str(start_time)])
    print "UI Sujet 1 Stopping ....\n"
...
fResults.write("\n")
fResults.write("ROBOT TIME" + "\t" + "PATH POSITION 1" + "\t" + "PATH POSITION 2" + "\t" + "POSITION SUBJECT 1" + "\t" + "POSITION SUBJECT 2" + "\t" + "FORCE SUBJECT 1" + "\t" + "FORCE SUBJECT 2" + "\t" + "POSITION X OBSTACLE" + "\t" + "POSITION Y OBSTACLE"  + "\t" + "RADIUS OBSTACLE" + "\n")
fResults.write("\n")
...
for line in fData: #Ecriture des donnes (avec synchronisation)
    ...
    if float(finalTime) <= 4*PATH_DURATION/5:
        timePaddleModified = timePaddle
    else:
    ...
    lineWritten = str(timePaddle) + "\t" + str(pathPos1) + "\t" + str(pathPos2) + "\t" + str(position1) + "\t" + str(position2) + "\t" + str(force1) + "\t" + str(force2) + "\t" + str(x_obst) + "\t" + str(y_obst)+ "\t" + str(radius_obst) + "\n"
