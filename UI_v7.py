...
def receive_data():
    ...
    while thread_alive:
        ...
        pos1 = (data1-POSITION_OFFSET)/POSITION_OFFSET*SENSITIVITY
        data2, addr = sock2.recvfrom(1024)
        data2 = float(data2[0:data2.find("\n")])
        pos2 = (data2-POSITION_OFFSET)/POSITION_OFFSET*SENSITIVITY
...
def terminate():
    ...
    thread_alive = False
    if SUJET==1:
        sock_envoi.sendto("STOP\0", (UDP_IP2, UDP_PORT3))
        sock_envoi.close()
