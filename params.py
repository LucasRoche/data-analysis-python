...
UDP_IP = "192.168.7.1"     # IP address of UI computer
UDP_IP2 = "192.168.7.2"    # IP address of paddle computer
TCP_IP = "192.168.7.2"
...
POSITION_OFFSET = 1.25 #number of ticks to the middle position
SENSITIVITY = 3 #ratio : cursor pos/ handle pos
