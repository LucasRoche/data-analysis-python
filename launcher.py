...
def UI_Sujet1():
    ...
    subprocess.call(["/home/lucas/phri/MANIP/src/UI_v7.py", scenario_number, "1" , str(start_time)])



def UI_Sujet2():
    print "UI Sujet 2 Starting ....\n"
    subprocess.call(["/home/lucas/phri/MANIP/src/UI_v7.py", scenario_number, "2" , str(start_time)])
...
subprocess.call(["scp","ubuntu@192.168.7.2:/home/ubuntu/TEST/controller/data/data.txt","../data/"])
...
fResults.write('SENSITIVITY : ' + str(SENSITIVITY) + "\n")
